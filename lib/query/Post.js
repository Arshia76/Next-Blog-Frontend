...
export function useGetPostDetail(postId, onSuccess, onError) {
  return useQuery([keys.GET_POST_DETAIL, postId], () => getPostDetail(id), {
    onSuccess,
    onError,
  });
}
...
export function useSearchPosts(postId, onSuccess, onError) {
  return useQuery([keys.GET_SEARCH_POSTS, postId], () => searchPosts(postId), {
    onSuccess,
    onError,
  });
}
